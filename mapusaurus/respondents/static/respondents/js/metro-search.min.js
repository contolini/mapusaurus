...
$(document).ready(function() {
    ...
    search.initialize(), searchNameBox.typeahead({
        ...
        var re = new RegExp("^" + year, "i"), geoID = suggestion.geoid.replace(re, "");
        msaField.val(geoID).data("name", suggestion.name), $("#metro-search__submit").prop("disabled", !1).removeClass("btn__disabled");
    });
});
